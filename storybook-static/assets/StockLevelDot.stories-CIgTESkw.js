import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{P}from"./package-BbLLe93C.js";import"./createLucideIcon-CjmIsPIC.js";import"./iframe-ZdZ-P0sQ.js";import"./preload-helper-Dp1pzeXC.js";function E(s,r,a){const t=(a==null?void 0:a.nearMultiplier)??1.25,n=r??0;if(n<=0)return s<=0?"critical":"ok";if(s<n)return"critical";const i=Math.ceil(n*t);return s<=i?"warn":"ok"}const D={critical:"bg-red-500 shadow-[0_0_0_1px_rgba(220,38,38,0.35)]",warn:"bg-amber-400 shadow-[0_0_0_1px_rgba(217,119,6,0.35)]",ok:"bg-emerald-500 shadow-[0_0_0_1px_rgba(5,150,105,0.35)]"};function A(s,r,a){if(a==null||a<=0)return s==="critical"?`Sin stock (${r} unidades)`:`En stock (${r} unidades)`;switch(s){case"critical":return`Stock bajo el mínimo: ${r} unidades, mínimo ${a}`;case"warn":return`Stock cercano al mínimo: ${r} unidades, mínimo ${a}`;default:return`Stock en nivel cómodo: ${r} unidades, mínimo ${a}`}}const o=({quantity:s,minimumStock:r,nearMultiplier:a,className:t="","aria-label":n})=>{const i=E(s,r,{nearMultiplier:a}),l=n??A(i,s,r);return e.jsx("span",{role:"img","aria-label":l,title:l,className:`inline-block h-2 w-2 shrink-0 rounded-full ${D[i]} ${t}`})};o.__docgenInfo={description:`Punto de estado de inventario (listados de productos, tarjetas de catálogo).
Colores: rojo bajo el mínimo, amarillo zona cercana al mínimo, verde por encima.`,methods:[],displayName:"StockLevelDot",props:{quantity:{required:!0,tsType:{name:"number"},description:""},minimumStock:{required:!1,tsType:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]},description:""},nearMultiplier:{required:!1,tsType:{name:"number"},description:""},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}},"aria-label":{required:!1,tsType:{name:"string"},description:"Override accessible name (Spanish defaults below)."}}};const $=({title:s,subtitle:r,trailing:a,media:t,children:n,footer:i,className:l=""})=>e.jsxs("article",{className:`flex flex-col rounded-2xl border border-gray-100 bg-white shadow-sm transition-shadow hover:shadow-md ${l}`,children:[e.jsxs("div",{className:"flex items-start justify-between gap-3 border-b border-gray-50 px-4 pb-3 pt-4",children:[e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h3",{className:"truncate font-semibold text-base leading-snug text-gray-900",children:s}),r!=null&&r!==""&&e.jsx("p",{className:"mt-0.5 truncate text-sm text-gray-500",children:r})]}),a!=null&&a!==!1&&e.jsx("div",{className:"flex shrink-0 flex-wrap items-center justify-end gap-1",children:a})]}),t!=null&&e.jsx("div",{className:"relative mx-4 mb-1 mt-3 aspect-[4/3] overflow-hidden rounded-xl bg-gray-100",children:t}),n!=null&&e.jsx("div",{className:"flex flex-1 flex-col gap-3 px-4 pb-4 pt-3",children:n}),i!=null&&i!==!1&&e.jsx("div",{className:"border-t border-gray-50 px-4 py-3",children:i})]});$.__docgenInfo={description:`Catalog-style card for grids (products, SKUs, variants): header band, media, body, footer.
Neutral chrome so hosts control accents via chips inside slots.`,methods:[],displayName:"ListingCard",props:{title:{required:!0,tsType:{name:"string"},description:""},subtitle:{required:!1,tsType:{name:"string"},description:""},trailing:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Small trailing badge cluster (e.g. status)"},media:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Media slot (image, placeholder icon, etc.)"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Body metrics / meta below media"},footer:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Footer actions row"},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}}}};const z={title:"Components/StockLevelDot",component:o,parameters:{docs:{description:{component:"Indicador puntual para cantidad vs stock mínimo: rojo si la cantidad es menor que el mínimo; amarillo si está en el mínimo o en la banda cercana (por defecto hasta ceil(mínimo × 1,25)); verde por encima de esa banda. Sin mínimo definido (≤ 0): rojo solo si la cantidad es 0 o menor, verde si hay stock."}}},argTypes:{quantity:{control:{type:"number"}},minimumStock:{control:{type:"number"}},nearMultiplier:{control:{type:"number",step:.05,min:1}}}},d={name:"Rojo (bajo el mínimo)",args:{quantity:4,minimumStock:10}},c={name:"Amarillo (cerca del mínimo)",args:{quantity:11,minimumStock:10}},m={name:"Verde (en stock)",args:{quantity:40,minimumStock:10}},p={name:"Sin mínimo (solo hay / no hay)",render:()=>e.jsxs("div",{className:"flex flex-wrap items-center gap-6",children:[e.jsxs("div",{className:"flex items-center gap-2 text-sm text-gray-700",children:[e.jsx(o,{quantity:0}),e.jsx("span",{children:"Cantidad 0"})]}),e.jsxs("div",{className:"flex items-center gap-2 text-sm text-gray-700",children:[e.jsx(o,{quantity:12}),e.jsx("span",{children:"Cantidad 12"})]})]})},u={name:"Tabla (mínimo = 10, multiplicador 1,25)",render:()=>{const a=[0,5,9,10,12,13,14,50].map(t=>({qty:t,tone:E(t,10,{nearMultiplier:1.25})}));return e.jsxs("div",{className:"max-w-md space-y-3 font-mono text-sm",children:[e.jsxs("p",{className:"text-xs text-gray-500",children:["Límite superior banda amarilla: ceil(",10," × ",1.25,") = ",Math.ceil(10*1.25)]}),e.jsxs("table",{className:"w-full border-collapse border border-gray-200",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-gray-50 text-left text-xs uppercase tracking-wide text-gray-500",children:[e.jsx("th",{className:"border border-gray-200 px-2 py-1",children:"Cantidad"}),e.jsx("th",{className:"border border-gray-200 px-2 py-1",children:"Nivel"}),e.jsx("th",{className:"border border-gray-200 px-2 py-1",children:"Punto"})]})}),e.jsx("tbody",{children:a.map(({qty:t,tone:n})=>e.jsxs("tr",{children:[e.jsx("td",{className:"border border-gray-200 px-2 py-1",children:t}),e.jsx("td",{className:"border border-gray-200 px-2 py-1",children:n}),e.jsx("td",{className:"border border-gray-200 px-2 py-1",children:e.jsx(o,{quantity:t,minimumStock:10,nearMultiplier:1.25})})]},t))})]})]})}},x={name:"Ejemplo en ListingCard",render:()=>e.jsx("div",{className:"max-w-sm",children:e.jsx($,{title:"Producto demo",subtitle:"Categoría",media:e.jsx("div",{className:"flex h-full w-full items-center justify-center bg-gray-100",children:e.jsx(P,{className:"h-14 w-14 text-gray-400","aria-hidden":!0})}),children:e.jsx("div",{className:"rounded-xl border border-gray-100 bg-gray-50 px-3 py-2",children:e.jsxs("div",{className:"flex flex-col gap-0.5 sm:flex-row sm:items-center sm:justify-between",children:[e.jsxs("span",{className:"inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-gray-500",children:[e.jsx(o,{quantity:11,minimumStock:10}),"Stock disponible"]}),e.jsx("span",{className:"text-base font-bold text-gray-900",children:"11 u."})]})})})})};var g,b,y;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: 'Rojo (bajo el mínimo)',
  args: {
    quantity: 4,
    minimumStock: 10
  }
}`,...(y=(b=d.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var f,h,N;c.parameters={...c.parameters,docs:{...(f=c.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: 'Amarillo (cerca del mínimo)',
  args: {
    quantity: 11,
    minimumStock: 10
  }
}`,...(N=(h=c.parameters)==null?void 0:h.docs)==null?void 0:N.source}}};var j,v,w;m.parameters={...m.parameters,docs:{...(j=m.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: 'Verde (en stock)',
  args: {
    quantity: 40,
    minimumStock: 10
...
}`,...(L=(R=u.parameters)==null?void 0:R.docs)==null?void 0:L.source}}};var M,_,T;x.parameters={...x.parameters,docs:{...(M=x.parameters)==null?void 0:M.docs,source:{originalSource:`{
